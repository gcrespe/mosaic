...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Alpaca Trading Algorithm')
    parser.add_argument('symbols', nargs='+', help='Trading symbols (e.g., AAPL TSLA)')
    parser.add_argument('--lot', type=float, default=2000, help='Lot size in dollars')
